...
/// With <see cref="GCL.Base.Data.AuditableDbContext{T}"/>, reads are scoped by a global query filter (no match when tenant is missing unless suppressed)
...
/// or globally for the current flow with <see cref="TenantQueryFilterScope"/> / <see cref="GCL.Base.Security.IUserContext.BypassTenantQueryFilter"/>.
/// </summary>
