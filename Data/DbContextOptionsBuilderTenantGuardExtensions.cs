...
public static class DbContextOptionsBuilderTenantGuardExtensions
{
    ...
    /// Requires <see cref="GCL.Base.Security.UserContextServiceCollectionExtensions.AddUserContext(Microsoft.Extensions.DependencyInjection.IServiceCollection)"/> (or manual <c>AddScoped&lt;TenantContextRequiredCommandInterceptor&gt;()</c>).
    /// </summary>
